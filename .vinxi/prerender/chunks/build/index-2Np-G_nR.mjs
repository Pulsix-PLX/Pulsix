...
const A = E(async function(s) {
  ...
  try {
    return (_b = (_a = await r.query("SELECT * FROM transactions WHERE wallet_id = $1 ORDER BY date DESC", [s])) == null ? void 0 : _a.rows) != null ? _b : [];
  } catch (l) {
...
export { A, I };
//# sourceMappingURL=index-2Np-G_nR.mjs.map
