...
import * as h$1 from 'bcryptjs';
import { Y, Q as Q$1 } from '../_/nitro.mjs';
import { initializeApp } from 'firebase/app';
import { getAnalytics, setAnalyticsCollectionEnabled } from 'firebase/analytics';
import { getAuth, RecaptchaVerifier, signInWithPhoneNumber, GoogleAuthProvider } from 'firebase/auth';
import { y as ye, r, v as ve, f as fe, j } from './Inputs-BxVpbjg0.mjs';
...
const W = w(async (t) => {
  ...
  try {
    ...
    const S = await h$1.hash(u, 10), v = (await D.query(`INSERT INTO users 
...
const [se, $e] = createSignal(""), [p, d] = createSignal(""), [oe, h] = createSignal(""), g = () => `${$()}${ye("phone")}`, [$, Se] = createSignal("+39"), [_e, Oe] = createSignal(""), [ne, Te] = createSignal(null);
function Ne() {
  ...
  return createMemo(() => {
    ...
    return [createComponent(Match, { get when() {
      ...
      return ssr(te, ssrHydrationKey(), "w-300 mt-100", "justify-items:center", ssrAttribute("value", escape($(), true), false), escape(createComponent(ve, { type: "phoneNumber", name: "phone", placeholder: "Phone number", get mountOn() {
        return s() == 1;
...
export { I, Ne as N, X, d, ee as e, g, h, ie as i, me as m, p };
//# sourceMappingURL=otpInput-Jfxp9i2z.mjs.map
