...
import { v4 } from 'uuid';
import { e as i, g as t, n as Re, j as be } from '../_/nitro.mjs';
import { w, I } from './utils-CmG_3rtr.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
...
`, k = [v4(), e.id, d, l, /* @__PURE__ */ new Date(), m, S.toISOString(), /* @__PURE__ */ new Date()];
    ...
    try {
      Re(r.nativeEvent, "refresh_token", n.token, { httpOnly: true, secure: o.env.ENV === "production", sameSite: "strict", expires: v, path: "/", maxAge: g });
    } catch (o) {
