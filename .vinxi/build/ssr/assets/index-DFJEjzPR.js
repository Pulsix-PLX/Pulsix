import{c as f,d as h}from"./db.server-Cxzv6220.js";import{createComponent as o,ssr as u,ssrHydrationKey as d,ssrAttribute as p,escape as t}from"solid-js/web";import{createSignal as g,Show as y,createResource as b,Switch as x,Match as $,Suspense as W,lazy as D}from"solid-js";import{C as L,a as S,b as v}from"./prova-BQfA7nlw.js";import{e as C,s as _}from"./index-DYZ-zTTq.js";import{A}from"./components-eKl611cl.js";import{I as m}from"./Inputs-BxVpbjg0.js";import{g as O,s as N,a as c,d as k}from"./deleteWallet-CDUDB5HW.js";import{B as w}from"./ButtonSparkle-DNpTyev3.js";const R=f(async function(r){if(console.log(`[Server Function:fetchWalletsForUserId] Fetching per userId: ${r}`),isNaN(r))throw new Error("User ID non valido fornito a fetchWalletsForUserId.");try{return(await h.query("SELECT * FROM wallets WHERE user_id = $1 ORDER BY wallet_name",[r])).rows??[]}catch(l){throw console.error("[Server Function:fetchWalletsForUserId] Errore DB:",l),new Error("Errore recupero wallets.")}},"src_routes_API_Wallets_getWallets_server_ts--getWallets_1","C:/Users/Matteo/Desktop/Pulsix/src/routes/API/Wallets/getWallets.server.ts?tsr-directive-use-server="),te=R,M=f(async function(r,l){const n="[Server Function:getWalletsContainerEnhancedWithDeleteCheck]";if(console.log(`${n} Fetching per userId: ${r}, containerId: ${l}`),isNaN(r))throw console.error(`${n} User ID non valido fornito.`),new Error("User ID non valido fornito.");if(l!==null&&(typeof l!="number"||isNaN(l)))throw console.error(`${n} Container ID non valido fornito (Type: ${typeof l}, Value: ${l}).`),new Error("Container ID non valido fornito.");const i=l===null;try{const a=`
