...
import { q, j, J, V } from './exchangeRates-ChMJm5Xh.mjs';
...
function P(e) {
  ...
  return [createComponent(For, { get each() {
  ...
  }, children: (n, i) => createComponent(J, { get color() {
    return n.color;
  }, get wallet() {
    return n.wallet;
  }, get balance() {
    ...
    } }), ssr(E, ssrHydrationKey(), ` ${escape(V.backCardHolder, true)}`, `height:${((_b = escape((_a = e.data) == null ? void 0 : _a.length, true)) != null ? _b : escape(u.length, true)) * 2 + 11}vw;margin-top:-${((_d = escape((_c = e.data) == null ? void 0 : _c.length, true)) != null ? _d : escape(u.length, true)) * 2 + 2.5}vw;z-index:-10`), ssr(U, ssrHydrationKey(), escape(e.name), escape(createComponent(Show, { get when() {
...
export { L, P, m };
//# sourceMappingURL=index-CM2EfUOf.mjs.map
