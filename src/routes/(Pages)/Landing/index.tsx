...
export default function Index() {
  ...
  return (
    <>
      ...
      <div class="flex items-center justify-center mt-150 pb-50 pt-10">
        <div class="text-center">
          
        <AnimatedText changeInterval={5000} initialAnimation="fade" texts={[
          "Save your wallets", 
          "Trace your expenses",
          "Manage your money" 
          ]}/>
      ...
      <div class="flex flex-col items-center justify-center mt-50 pb-50 pt-10">
        <ButtonSparkle
          text="Get started"
          shadow={40}
          size = {2}
      ...
      <div class="flex justify-center items-center h-500 gap-4 ">
        <div class="w-1/4 p-4">
          <Card
            title="dio lebbroso"
