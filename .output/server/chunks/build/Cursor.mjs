...
const [q, G] = createSignal(true), J = () => {
  ...
  return onMount(() => {
    ...
    document.addEventListener("mousemove", $), document.addEventListener("mouseover", f), document.addEventListener("mouseout", I), document.addEventListener("mousedown", h), document.addEventListener("mouseup", N), document.body.style.cursor = "none", onCleanup(() => {
      document.removeEventListener("mousemove", $), document.removeEventListener("mouseover", f), document.removeEventListener("mouseout", I), document.removeEventListener("mousedown", h), document.removeEventListener("mouseup", N), clearInterval(U);
    });
...
export { J as default, G as setShowCursor, q as showCursor };
