...
import { q, j, J as J$1, V } from './exchangeRates-ChMJm5Xh.mjs';
...
const [m, J] = createSignal(null);
function M(t) {
  const [p, S] = createSignal(false), u = [{ color: "", wallet: "nothing", balance: 0, currency: "USD", id: 0 }], g = "EUR", [r] = createResource(() => ({ containerId: t.id, targetCurrency: g }), async (n) => {
  ...
  }, children: (n, i) => createComponent(J$1, { get color() {
    return n.color;
  }, get wallet() {
    return n.wallet;
  }, get balance() {
...
export { M as default, m as edit, J as setEdit };
