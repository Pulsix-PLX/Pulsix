...
import { p, D, d, x as x$1 } from './deleteWallet-Cgff9KFR.mjs';
...
const T = lazy(() => import('./index-WwoiZKEg2.mjs').then((e) => ({ default: e.DefaultColorPicker })));
function Y() {
...
export { X, Y };
//# sourceMappingURL=index-0U8vmGbf.mjs.map
